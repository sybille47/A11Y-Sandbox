    ...
    <>
      ...
      <Routes>
        ...
        <Route
          path="/why"
          element={
            <Layout prevPath="/intro" nextPath="/how" currentStep={3} totalSteps={totalSteps}>
              <WhyAccess />
            </Layout>
          }
        />
        ...
        <Route
          path="/how"
          element={
            <Layout prevPath="/why" nextPath="/contrast" currentStep={4} totalSteps={totalSteps}>
              <HowAccess />
            </Layout>
          }
        />
        ...
        <Route
          path="/contrast"
          element={
            <Layout prevPath="/how" nextPath="/form" currentStep={5} totalSteps={totalSteps}>
              <ContrastDemo />
            </Layout>
          }
        />
        ...
        <Route
          path="/form"
          element={
            <Layout prevPath="/contrast" nextPath="/prefs" currentStep={6} totalSteps={totalSteps}>
              <FormDemo />
            </Layout>
          }
        />
